...
class OkUser:
    ...
    def _ok_request_json(self, session_secret_key, access_token):
        ...
        key_status = "error_code"
        ok_request = requests.get(self.ok_url, params={**self.params, **params_req})
        if key_status in json.loads(ok_request.content):
            return 103
        else:
            return ok_request.json()['photos']
